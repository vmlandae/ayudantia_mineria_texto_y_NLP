...
* Preprocesamiento
  ...
  * Transformación:
    ...
    * Procesos típicos: todo a minúsculas, sacar puntuación, números, *stopwords*, etcétera.
    * *tokenización*: separar el texto en sus partes fundamentales. 
...
## Strings (Cadenas de caracteres) (extraido de R4DS)
